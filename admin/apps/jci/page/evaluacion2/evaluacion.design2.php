                ...
                <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fw-semibold mb-n2">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4 active" data-bs-toggle="tab"
                            href="#kt_ecommerce_add_product_general">SEGURIDAD DEL PACIENTE</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                            href="#kt_ecommerce_add_product_advanced">CONDUCTUAL</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab"
                            href="#kt_ecommerce_add_product_reviews">CONTINUIDAD DE LA ATENCIÓN</a>
                    </li>
                </ul>
                <!--end:::Tabs-->
                <!--begin::Tab content-->
                            ...
                            <div class="card card-flush py-4">
                                ...
                                <div class="card-header">
                                    <div class="card-title">
                                        <h2>Datos</h2>
                                        <!--begin::Svg Icon | path: /var/www/preview.keenthemes.com/kt-products/good/releases/2022-08-13-004438/core/html/src/media/icons/duotune/communication/com013.svg-->
                                                ...
                                                <div data-repeater-list="kt_ecommerce_add_product_options"
                                                    ...
                                                    <div data-repeater-item
                                                        ...
                                                        <div class=" flex-column gap-3">
                                                            <label class="form-label" form="periodo">Bimestre</label>
                                                            <select id="periodo" name="periodo"
                                                                class="form-select select2 formValidationSelect2"
                                                                data-allow-clear="true"
                                                                data-placeholder="Seleccione Periodo">
                                                                <option></option>
                                                                <option value="1">1°Bimestre</option>
                                                                <option value="2">2°Bimestre</option>
                                                                <option value="3">3°Bimestre</option>
                                                        ...
                                                        <!--begin::Input-->
                                                        <input type="text" class="form-control mw-300 w-200px"
                                    ...
                                    <div class="fv-row">
                                        ...
                                        <div class="form-check form-check-custom form-check-solid mb-2">
                                            <input class="form-check-input" type="checkbox"
                                                id="kt_ecommerce_add_product_shipping_checkbox" value="1" checked />
                                            <label class="form-check-label">
                                    ...
                                    <table class="table table-row-dashed fs-6 gy-5 my-0"
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/good/apps/inbox/reply.html"
                                                    ...
                                                    <a href="/good/apps/inbox/reply.html"
                                                        ...
                                                        <div class="symbol symbol-circle symbol-25px me-3">
                                                            <span class="symbol-label"
                                                                style="background-image:url(/good/assets/media/avatars/300-1.jpg)"></span>
                                                        </div>
                                                        <!--end::Avatar-->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/good/apps/inbox/reply.html"
                                                        ...
                                                        <div class="symbol symbol-circle symbol-25px me-3">
                                                            <span class="symbol-label"
                                                                style="background-image:url(/good/assets/media/avatars/300-5.jpg)"></span>
                                                        </div>
                                                        <!--end::Avatar-->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/good/apps/inbox/reply.html"
                                                        ...
                                                        <div class="symbol symbol-circle symbol-25px me-3">
                                                            <span class="symbol-label"
                                                                style="background-image:url(/good/assets/media/avatars/300-25.jpg)"></span>
                                                        </div>
                                                        <!--end::Avatar-->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/good/apps/inbox/reply.html"
                                                        ...
                                                        <div class="symbol symbol-circle symbol-25px me-3">
                                                            <span class="symbol-label"
                                                                style="background-image:url(/good/assets/media/avatars/300-9.jpg)"></span>
                                                        </div>
                                                        <!--end::Avatar-->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/good/apps/inbox/reply.html"
                                                        ...
                                                        <div class="symbol symbol-circle symbol-25px me-3">
                                                            <span class="symbol-label"
                                                                style="background-image:url(/good/assets/media/avatars/300-23.jpg)"></span>
                                                        </div>
                                                        <!--end::Avatar-->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/good/apps/inbox/reply.html"
                                                        ...
                                                        <div class="symbol symbol-circle symbol-25px me-3">
                                                            <span class="symbol-label"
                                                                style="background-image:url(/good/assets/media/avatars/300-12.jpg)"></span>
                                                        </div>
                                                        <!--end::Avatar-->
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="/good/apps/inbox/reply.html"
                                                        ...
                                                        <div class="symbol symbol-circle symbol-25px me-3">
                                                            <span class="symbol-label"
                                                                style="background-image:url(/good/assets/media/avatars/300-13.jpg)"></span>
                                                        </div>
                                                        <!--end::Avatar-->
