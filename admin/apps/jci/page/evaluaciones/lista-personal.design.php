    ...
    <div id="kt_app_content_container" class="app-container  container-fluid ">
        ...
        <div class="card">
                ...
                <div class="card-title">
                    ...
                    <div class="d-flex align-items-center position-relative my-1">
                        ...
                        <!--end::Svg Icon--> <input type="text" data-kt-customer-table-filter="search"
                            class="form-control form-control-solid w-250px ps-15" placeholder="Buscar alumni" />
                    </div>
                    <!--end::Search-->
                </div>
                <!--begin::Card title-->
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <button type="button" class="btn btn-light-primary me-3" data-bs-toggle="modal"
                            data-bs-target="#kt_personal_filtro_modal">
            ...
            <div class="card-body pt-0">
                ...
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="tb_personal">
                    <!--begin::Table head-->
                    <thead>
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            <th class="w-10px pe-2">
                                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                    <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#tb_personal .form-check-input" value="1"/>
                                </div>
                            </th>
                            <th>Código</th>
                            <th>Colaborador</th>
        ...
        <!--begin::Modal - Adjust Balance-->
        <div class="modal fade" id="kt_personal_filtro_modal" tabindex="-1" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog modal-dialog-centered mw-650px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                        <!--begin::Form-->
                        <form id="kt_personal_filtro_form" class="form" action="#">
                            <!--begin::Input group-->
                            <div class="fv-row mb-10">
                                <!--begin::Label-->
                                <label class="form-label fs-5 fw-semibold mb-3">Nacionalidad:</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-select form-select-solid fw-bold" data-control="select2" data-close-on-select="false" 
                                    data-placeholder="Selecione una nacionalidad" data-allow-clear="true" multiple="multiple">
                                    <option></option>
                                    <?php                                            
                                        $sql = "SELECT DISTINCT 
                                                    A.NCOLA_NACIONALIDAD ID,
                                                    LOWER(B.CNACI_DESCRIPCION) DESCRIP
                                                FROM SRD_COLABORADORES A 
                                                INNER JOIN SRD_NACIONALIDAD B ON A.NCOLA_NACIONALIDAD = B.NNACI_ID
                                                WHERE CCOLA_ESTADO = '1' AND A.NCOLA_NACIONALIDAD IS NOT NULL OR A.NCOLA_NACIONALIDAD <> ''
                                                ORDER BY DESCRIP ASC;";
                                        $result = $conn->query($sql);
                                        if ($result->num_rows > 0) {
                                            while($row = $result->fetch_assoc()) { ?>
                                                <option value="<?php echo $row["ID"]; ?>"><?php echo ucwords($row["DESCRIP"]); ?></option> <?php 
                                            }
                                        }
                                    ?>
                                </select>
                            ...
                            <div class="fv-row mb-10">
                                <!--begin::Label-->
                                <label class="form-label fs-5 fw-semibold mb-3">Desempeño:</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-select form-select-solid fw-bold" data-control="select2" data-close-on-select="false" 
                                    data-placeholder="Seleccione un desempeño" data-allow-clear="true" multiple="multiple">
                                    <option></option>
                                    <?php
                                        $sql = "SELECT DISTINCT 
                                                    A.NCOLA_DESEMPENIO ID,
                                                    LOWER(B.CDESE_DESCRIPCION) DESCRIP
                                                FROM SRD_COLABORADORES A 
                                                INNER JOIN SRD_DESEMPENIO B ON A.NCOLA_DESEMPENIO = B.NDESE_ID
                                                WHERE CCOLA_ESTADO = '1' AND CDESE_DESCRIPCION IS NOT NULL OR CDESE_DESCRIPCION <> ''
                                                ORDER BY DESCRIP ASC;";
                                        $result = $conn->query($sql);
                                        if ($result->num_rows > 0) {
                                            while($row = $result->fetch_assoc()) { ?>
                            ...
                            <div class="fv-row mb-10">
                                <!--begin::Label-->
                                <label class="form-label fs-5 fw-semibold mb-3">Ocupación:</label>
                                <!--end::Label-->
                                <!--begin::Input-->
                                <select class="form-select form-select-solid fw-bold" data-control="select2" data-close-on-select="false" 
                                    data-placeholder="Seleccione una ocupación" data-allow-clear="true" multiple="multiple">
                                    <option></option>
                                    <?php                                            
                                        $sql = "SELECT DISTINCT 
                                                    A.NCOLA_OCUPACION ID,
                                                    LOWER(B.COCUP_DESCRIPCION) DESCRIP
                                                FROM SRD_COLABORADORES A 
                                                INNER JOIN SRD_OCUPACION B ON A.NCOLA_OCUPACION = B.NOCUP_ID
                                                WHERE CCOLA_ESTADO = '1' AND COCUP_DESCRIPCION IS NOT NULL OR COCUP_DESCRIPCION <> ''
                                                ORDER BY DESCRIP ASC;";
                                        $result = $conn->query($sql);
                                        if ($result->num_rows > 0) {
                                            while($row = $result->fetch_assoc()) { ?>
                            ...
                            <!--begin::Actions-->
                            <div class="text-center">
                                <button type="reset" id="kt_personal_filtro_cancel" class="btn btn-light me-3">
                                    Cancelar
                                </button>

                                <button type="submit" id="kt_personal_filtro_submit" class="btn btn-primary">
                                    <span class="indicator-label">
                                        Filtrar
                                    </span>
                                    <span class="indicator-progress">
