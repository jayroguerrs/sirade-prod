...
<?php include 'partials/theme-mode/_init.php' ?>
        ...
        <div class="d-flex flex-column flex-root" id="kt_app_root">
            ...
            <div class="d-flex flex-row-fluid flex-column flex-column-fluid text-center p-10 py-lg-20">
					...
					<a href="./" class="pt-lg-20 mb-12">
						<img alt="Logo" src="assets/media/logos/default.svg" class="h-90px" />
					</a>
					<!--end::Logo-->
					<!--begin::Logo-->
					<h1 class="fw-bold fs-2qx text-gray-800 mb-10">Registro Incompleto</h1>
					<!--end::Logo-->
					<!--begin::Message-->
					<div class="fw-semibold fs-3 text-muted mb-15">Favor de indicar a la Dirección de Enfermería culminar su proceso de registro.</div>
					<!--end::Message-->
					<!--begin::Action-->
					<div class="text-center">
						<a href="javascript:Ingresar();" class="btn btn-lg btn-primary fw-bold">Iniciar Sesión</a>
					</div>
					<!--end::Action-->
				</div>
       ...
       <script>
        ...
        <script src="apps/julia/auth/verify-usr/verify-usr.model.js"></script>
