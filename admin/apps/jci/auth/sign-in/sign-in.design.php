                ...
                <div class="d-flex flex-column flex-lg-row-auto bg-primary w-xl-600px positon-xl-relative">
                    ...
                    <div class="d-flex flex-column position-xl-fixed top-0 bottom-0 w-xl-600px scroll-y">
                        ...
                        <div class="d-flex flex-row-fluid flex-center flex-column text-center p-5 p-lg-5">          
                            ...
                            <!--begin::Description-->
							<p class="d-none d-lg-block fw-semibold fs-2 text-white">JointComission Formulario
							<br />Eforms</p>
							<!--end::Description-->
                        </div>
                        <!--end::Header-->
				...
				<div class="d-flex flex-column flex-lg-row-fluid py-10">
					...
					<div class="d-flex flex-center flex-column flex-column-fluid">
						...
						<div class="w-lg-500px p-10 p-lg-15 mx-auto">
							...
							<form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="./" action="login">
                                ...
                                <input type="hidden" name="registro" value="signin"/>
								<!--end::Actions-->
							</form>
							<!--end::Form-->
						</div>
                    ...
                    <div class="d-flex flex-center flex-wrap fs-6 p-5 pb-0">
						...
						<div class="d-flex flex-center fw-semibold fs-6">							
                            <a href="login?tipo=alumni" class="text-muted text-hover-primary px-2" >Inicio</a>
							<a href="index?tipo=admin" class="text-muted text-hover-primary px-2">Página Web</a>
						</div>
						<!--end::Links-->
					</div>
					<!--end::Footer-->
