...
<html lang="en" >
    <!--begin::Head-->
    <head><base href=""/>
        <title>JointComission | SISTEMA DE ENFERMERIA FORMS</title>
        <meta charset="utf-8"/>
...
<?//php include 'partials/modals/_invite-friends.php' ?>
        ...
        <script src="apps/jci/auth/sign-out/sign-out.model.js"></script>
...
<?php
    ...
    } elseif ($page == 'lista-alumni') {?>
        <script src="page/alumni/lista/lista-alumni.model.js"></script> <?php
    }
?>
