...
<html lang="en" >
    <!--begin::Head-->
    <head><base href=""/>
        <title>JULIA | SISTEMA DE GESTIÓN Y CONTROL DE ASISTENCIAS</title>
        <meta charset="utf-8"/>
        <meta name="description" content="JULIA, SISTEMA DE GESTIÓN Y CONTROL DE ASISTENCIAS"/>
        ...
        <meta property="og:title" content="JULIA, SISTEMA DE GESTIÓN Y CONTROL DE ASISTENCIAS" />
...
<?//php include 'partials/modals/create-campaign/_main.php' ?>
...
<?//php include 'partials/modals/_invite-friends.php' ?>
        ...
        <script src="apps/julia/auth/sign-out/sign-out.model.js"></script>
...
<?php
    if($page == 'index'){ ?>
        <script src="page/dashboards/demografico/demografico.model.js"></script> <?php
    } elseif ($page == 'lista-personal') {?>
        <script src="apps/julia/page/personal/lista/lista-personal.model.js"></script> <?php
    } elseif ($page == 'editar-personal') {?>
        <script src="apps/julia/page/personal/editar/editar-personal.model.js"></script> <?php
    }    
?>
