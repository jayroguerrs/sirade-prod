...
<?php include 'partials/theme-mode/_init.php' ?>
        ...
        <div class="d-flex flex-column flex-root" id="kt_app_root">
            ...
            <div class="d-flex flex-row-fluid flex-column flex-column-fluid text-center p-10 py-lg-20">
					...
					<!--end::Logo-->
					<!--begin::Logo-->
					<h1 class="fw-bold fs-2qx text-gray-800 mb-10">Ops !</h1>
					<!--end::Logo-->
					<!--begin::Message-->
					<div class="fw-semibold fs-3 text-muted mb-15">Al parecer la página que buscas no existe
					<br />Por favor intente mas tarde.</div>
					<!--end::Message-->
					<!--begin::Action-->
					<div class="text-center">
						<a href="../" class="btn btn-lg btn-primary fw-bold">Ir al Inicio</a>
					</div>
					<!--end::Action-->
				</div>
       ...
       <script>
        ...
        <script src="apps/teleenfermeria/auth/sign-in/sign-in.model.js"></script>
