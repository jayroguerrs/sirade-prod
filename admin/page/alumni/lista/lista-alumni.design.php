    ...
    <div id="kt_app_content_container" class="app-container  container-fluid ">
        ...
        <div class="card">
                ...
                <div class="card-toolbar">
                    ...
                    <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                        ...
                        <div class="menu menu-sub menu-sub-dropdown w-300px w-md-325px" data-kt-menu="true"
                            ...
                            <!--begin::Header-->
                            <div class="px-7 py-5">
                                <div class="fs-4 text-dark fw-bold">Opciones de Filtro</div>
                            </div>
                            <!--end::Header-->
                            ...
                            <div class="px-7 py-5">
                                ...
                                <div class="mb-10">
                                    <!--begin::Label-->
                                    <label class="form-label fs-5 fw-semibold mb-3">Tipo de Documento:</label>
                                    <!--end::Label-->
                                    ...
                                    <select class="form-select form-select-solid fw-bold" data-kt-select2="true"
                                        ...
                                        <option></option>
                                        <?php
                                            $sql = "SELECT DISTINCT TipoDoc FROM alumni where TipoDoc IS NOT NULL OR TipoDoc <> '' ";
                                            $result = $conn->query($sql);
                                            
                                            if ($result->num_rows > 0) {
                                                while($row = $result->fetch_assoc()) { ?>
                                                    <option value="<?php echo $row["TipoDoc"]; ?>"><?php echo $row["TipoDoc"]; ?></option> <?php 
                                              }
                                            }
                                        ?>                                        
                                    </select>
            ...
            <div class="card-body pt-0">
                ...
                <!--begin::Table-->
                <table class="table align-middle table-row-dashed fs-6 gy-5" id="tb_alumni">
                    <!--begin::Table head-->
                    <thead>
                        <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                            <th class="w-10px pe-2">
                                <div class="form-check form-check-sm form-check-custom form-check-solid me-3">
                                    <input class="form-check-input" type="checkbox" data-kt-check="true" data-kt-check-target="#tb_alumni .form-check-input" value="1"/>
                                </div>
                            </th>
                            ...
                            <th>Compañía</th>
                            <th>Cargo Actual</th>
                            <th>Cargo Estandar</th>
                            <th>Labores de Docencia</th>
                            <th>Graduación</th>
                            <th>Distinción</th>
                            <th>Categoría</th>
                            <th>Tipo de Postragrado</th>
