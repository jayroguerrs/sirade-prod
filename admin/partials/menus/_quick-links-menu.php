...
<span class="svg-icon svg-icon-3x svg-icon-primary mb-2"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<!--end::Svg Icon-->                <span class="fs-5 fw-semibold text-gray-800 mb-0">Accounting</span>
...
<!--end::Svg Icon-->                <span class="fs-5 fw-semibold text-gray-800 mb-0">Administration</span>
...
<!--end::Svg Icon-->                <span class="fs-5 fw-semibold text-gray-800 mb-0">Projects</span>
...
<!--end::Svg Icon-->                <span class="fs-5 fw-semibold text-gray-800 mb-0">Customers</span>
