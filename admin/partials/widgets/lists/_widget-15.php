...
<div class="card card-flush h-xl-100">
    ...
    <div class="card-header pt-5">
        ...
        <h3 class="card-title align-items-start flex-column">
            <span class="card-label fw-bold text-dark">PopuLar Products</span>
            <span class="text-gray-400 pt-2 fw-semibold fs-6">Latest bestsellers</span>
        </h3>
        <!--end::Title-->
        <!--begin::Toolbar-->
            ...
            <div class="d-flex align-items-sm-center mb-7">
                ...
                <div class="d-flex flex-stack w-100">
                    ...
                    <div class="my-lg-0 my-2 me-2">
                        ...
                        <span class="text-gray-400 fw-semibold d-block pt-1">Most Successful Fellas</span>
                    </div>
                    <!--end::Title-->
                    <!--begin::Menu-->
...
<span class="svg-icon svg-icon-5"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="d-flex align-items-sm-center mb-7">
                ...
                <div class="d-flex flex-stack w-100">
                    ...
                    <div class="my-lg-0 my-2 me-2">
                        ...
                        <span class="text-gray-400 fw-semibold d-block pt-1">Feminine all around</span>
                    </div>
                    <!--end::Title-->
                    <!--begin::Menu-->
                    <button class="btn btn-icon btn-sm w-30px h-30px btn-active-light-primary btn-active-color-primary btn-light"
            ...
            <div class="d-flex align-items-sm-center mb-7">
                ...
                <div class="d-flex flex-stack w-100">
                    ...
                    <div class="my-lg-0 my-2 me-2">
                        ...
                        <span class="text-gray-400 fw-semibold d-block pt-1">Visually stunning</span>
                    </div>
                    <!--end::Title-->
                    <!--begin::Menu-->
                    <button class="btn btn-icon btn-sm w-30px h-30px btn-active-light-primary btn-active-color-primary btn-light"
            ...
            <div class="d-flex align-items-sm-center mb-7">
                ...
                <div class="d-flex flex-stack w-100">
                    ...
                    <div class="my-lg-0 my-2 me-2">
                        ...
                        <span class="text-gray-400 fw-semibold d-block pt-1">The will to capture readers</span>
                    </div>
                    <!--end::Title-->
                    <!--begin::Menu-->
                    <button class="btn btn-icon btn-sm w-30px h-30px btn-active-light-primary btn-active-color-primary btn-light"
            ...
            <div class="d-flex align-items-sm-center ">
                ...
                <div class="d-flex flex-stack w-100">
                    ...
                    <div class="my-lg-0 my-2 me-2">
                        ...
                        <span class="text-gray-400 fw-semibold d-block pt-1">Food trends & inspirations</span>
                    </div>
                    <!--end::Title-->
                    <!--begin::Menu-->
                    <button class="btn btn-icon btn-sm w-30px h-30px btn-active-light-primary btn-active-color-primary btn-light"
