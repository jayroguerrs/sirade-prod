    ...
    <div class="card-header pt-5">
        ...
        <div class="card-title d-flex flex-column">
            ...
            <div class="d-flex align-items-center">
                ...
                <!--end::Currency-->
                <!--begin::Amount-->
                <span class="fs-2hx fw-bold text-dark me-2 lh-1">47,07</span>
                <!--end::Amount-->
                <!--begin::Badge-->
...
<span class="svg-icon svg-icon-7 svg-icon-white ms-n1"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
<!--end::Svg Icon-->
            ...
            <!--end::Info-->
            <!--begin::Subtitle-->
            <span class="d-flex align-items-center text-gray-400 pt-1 fw-semibold fs-6">
                Avg order Value
